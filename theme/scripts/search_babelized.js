function _instanceof(left, right) {
  ...
  var IndexHelper =
    ...
    (function() {
      ...
      function IndexHelper(documents) {
        ...
        this.indexes.content.add(documents); // console.log("done adding pages to index");
  ...
  var SearchService =
    ...
    (function() {
      ...
      function SearchService(tag, documents) {
      ...
      _createClass(SearchService, [
        {
          ...
          value: function query(querystr) {
            ...
            var joined =
              "(" + this.current_query.clean.split(" ").join("|") + ")";
            ...
            this.current_query.words = escaped
              .split(" ")
              .map(function(searchword) {
                ...
                regexstr = regexstr.replace(
                  /((?:att&ck)|(?:attack))/gi,
                  "((?:att&ck)|(?:attack))"
                ); //equivalence of ATT&CK and attack
        ...
        },
        {
          ...
          value: function result_to_html(result) {
            ...
            var path = site_base_url + result.path;
            ...
            function setsEqual(s1, s2) {
              ...
              try {
                for (
                  var _iterator = s1[Symbol.iterator](), _step;
            ...
            var allWords = new Set(
              this.current_query.words.map(function(word) {
                return word.word;
              })
            );
            var pos = 0;
            ...
            for (var i = 0; i < positions.length; i++) {
              ...
              if (
                ...
                (totalDist < best.totalDist && foundWords.size >= best.totalFound)
              ) {
                // new best
            ...
            preview = preview.replace(
              this.current_query.joined,
              "<span class='search-word-found'>$1</span>"
